...
public class BiscuitFormatterTest {
    ...
    public void testPoliciesOperations() {
        assertEquals("[\"all_read\",\"allow_clusters_read\",\"allow_custom_metric_labels_read\",\"anti_affinity_read\",\"auto_subscription_creation_read\",\"auto_subscription_creation_write\",\"auto_topic_creation_read\",\"auto_topic_creation_write\",\"backlog_read\",\"backlog_write\",\"cluster_migration_read\",\"compaction_read\",\"compaction_write\",\"deduplication_read\",\"deduplication_snapshot_read\",\"deduplication_snapshot_write\",\"deduplication_write\",\"delayed_delivery_read\",\"delayed_delivery_write\",\"dispatcher_pause_on_ack_state_persistent_read\",\"encryption_read\",\"encryption_write\",\"entry_filters_read\",\"inactive_topic_read\",\"inactive_topic_write\",\"max_consumers_read\",\"max_producers_read\",\"max_subscriptions_read\",\"max_topics_read\",\"max_unacked_read\",\"max_unacked_write\",\"namespace_isolation_read\",\"offload_read\",\"partition_read\",\"partition_write\",\"persistence_read\",\"persistence_write\",\"rate_read\",\"rate_write\",\"replication_rate_read\",\"replication_read\",\"resourcegroup_read\",\"retention_read\",\"retention_write\",\"schema_compatibility_strategy_read\",\"schema_compatibility_strategy_write\",\"shadow_topic_read\",\"subscription_auth_mode_read\",\"subscription_auth_mode_write\",\"subscription_expiration_time_read\",\"subscription_expiration_time_write\",\"ttl_read\",\"ttl_write\"]", policiesOperations);
    }
