...
public class AuthenticationProviderBiscuitTestLegacy {
  private static final Logger LOGGER = LoggerFactory.getLogger(AuthenticationProviderBiscuitTestLegacy.class);
  ...
  public void testAuthSecretKeyPair() throws Exception {
    ...
    AuthenticationProviderBiscuitLegacy provider = new AuthenticationProviderBiscuitLegacy();
